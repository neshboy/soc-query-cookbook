...
if __name__ == "__main__":
    in_path = sys.argv[1] if len(sys.argv) > 1 else r"C:\Users\User\projects\soc-query-cookbook\_build\SOC_Threat_Hunting_Query_Cookbook.pdf"
    out_path = sys.argv[2] if len(sys.argv) > 2 else r"C:\Users\User\projects\soc-query-cookbook\_build\SOC_Threat_Hunting_Query_Cookbook_watermarked.pdf"
